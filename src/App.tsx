...
function App() {
    ...
    const allImageLists = [imageUrls, imageUrls2, i4];

    return (
        <div>
            <head className="center flex flex-col items-start justify-center bg-[#1A3271]">
                <Header />
            ...
            <div className="bg-white">
                <div className="flex justify-center pb-4 divide-y divide-y-reverse">
                    <h1 className="flex flex-col-reverse  text-blue-900">Hello</h1>
                </div>
                <div className="flex flex-col-reverse divide-y divide-y-reverse">
                    {allImageLists.map((images, index) => (
                        <Webcard key={index} images={images} />
                    ))}
                </div>
            </div>
        </div>
